...
public class EmailS
{
    ...
    public void mandarMail(Cliente cli, FacturaEntity ctx1)
    {
        ...
        {
            string link = "http://facturae.softoursistemas.com?Factura=" + item.Id_factura;
            if ((bool)item.Nueva)
                cuerpo += "<tr><td><a href='" + link + "'>Factura: " + item.Num_serie + item.Num_factura + "</a></td></tr>";
        }
        ...
        "<tr><td colspan='2'>Gracias por utilizar la facturación electrónica de SOFTOUR.<br /><br /></td></tr>" +
        "<tr><td>Atentamente,</td></tr>" +
        "<tr><td>Softour Sistemas<br /><br /></td></tr>" +
        ...
        "<br />Si no consigue cargar la página mediante el enlace de acceso directo, pinche en la siguiente dirección, o cópiela en su navegador: http://facturae.softoursistemas.com <br /></td></tr>";
        cuerpo += "<tr><td colspan='2'style='font-weight: bold, font-size: 12px'><br />Confidencialidad</td></tr>" +
        "<tr><td colspan='2' style='font-size: 12px'>Este mensaje y sus archivos adjuntos van dirigidos exclusivamente a su destinatario, pudiendo contener información confidencial sometida a secreto profesional. No está permitida su reproducción o distribución sin la autorización expresa de Softour Sistemas, S.L. Si usted no es el destinatario final por favor elimínelo e infórmenos por esta vía.<br /></td></tr>";
        cuerpo += "<tr><td colspan='2' style='font-size: 12px'>De acuerdo con la Ley 34/2002 (LSSI) y la Ley 15/1999 (LOPD), usted tiene derecho al acceso, rectificación y cancelación de sus datos personales informados en el fichero del que es titular Softour Sistemas, S.L. Si desea modificar sus datos o darse de baja en el sistema de comunicación electrónica envíe un correo a admon@softoursistemas.com, indicando en la línea de “Asunto” el derecho que desea ejercitar.</td></tr>" +
            "</table>";
